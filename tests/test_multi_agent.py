...
you do not have to generate code''',
    ...
    protocol = CommunicationProtocol('requirement_manager<->product_manager, product_manager->developer', [requirement_manager, product_manager, developer])
